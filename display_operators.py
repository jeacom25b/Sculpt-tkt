...
class RamdomColors(bpy.types.Operator):
    bl_idname = "sculptkt.random_colors"
    bl_label = "Ramdom Colors"
    bl_description = "Ramdom Object Colors (only works with Blender Render)"
    bl_options = {"REGISTER", "UNDO"}
    ...
    hue_variation = bpy.props.FloatProperty(
        name = "Hue variation",
        description = "The ramdomness of color",
        default = 1,
        min = 0,
        max = 1,
    )
    ...
    saturation_variation = bpy.props.FloatProperty(
        ...
        description = "The ramdomness of saturation",
        default = 0.2,
        min = 0,
    )
...
class ClearColors(bpy.types.Operator):
    ...
    bl_description = "Clear Ramdomized colors"
    bl_options = {"REGISTER", "UNDO"}
