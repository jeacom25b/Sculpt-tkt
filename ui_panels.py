...
class EnvelopeBuilder(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row.prop(context.scene, "envelope_preset", text="")
        row.operator("sculptkt.save_envelope_armature", text="", icon="ZOOMIN")
        row.operator("sculptkt.delete_envelope_armature",
                     text="",
                     icon="ZOOMOUT"
                     ).preset_name = context.scene.envelope_preset

        col.separator()

        op = col.operator("sculptkt.load_envelope_armature", icon="MOD_ARMATURE")
        op.no_popup = True
        op.preset_name = context.scene.envelope_preset
